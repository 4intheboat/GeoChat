...
public:
    ...
    virtual std::vector <db::Message>
    selectMessages(std::function<bool(const db::Message &)> &&pred, const db::get_msg_opt_t &opt) const = 0;
...
public:
    ...
    selectMessages(std::function<bool(const db::Message &)> &&pred, const db::get_msg_opt_t &opt) const override;
...
public:
    ...
    std::vector <db::Message>
    selectMessages(std::function<bool(const db::Message &)> &&, const db::get_msg_opt_t &) const override { return {}; }
